...
import com.aar.android.util.SystemUiHider;
import com.aar.android.FullscreenActivity;
...
public class FullscreenActivity extends Activity implements OnClickListener {
	...
	private void startAudio() {
		...
		try {
			...
			pdService.startAudio(new Intent(this, FullscreenActivity.class), R.drawable.icon, name, "Return to " + name + ".");
		} catch (IOException e) {
			toast(e.toString());
		}
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.button_play).setOnTouchListener(
